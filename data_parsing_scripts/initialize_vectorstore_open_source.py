...
class VectorStoreInitializer:
    ...
    def _initialize_rag(self):
        ...
        print(f"\n🔗 Creating embeddings using Ollama (nomic-embed-text)...")
...
def main():
    ...
    # Check for OpenAI API key (only needed if using OpenAI embeddings)
    # if not os.getenv("OPENAI_API_KEY"):
    #     print("❌ Error: OPENAI_API_KEY environment variable not set")
    #     print("Please set your OpenAI API key before running this script")
    #     return

    print("ℹ️  Using Ollama embeddings (no API key required)")
    print("ℹ️  Make sure Ollama is running with 'nomic-embed-text' model pulled")
    print("ℹ️  Run: ollama pull nomic-embed-text\n")
